    ...
    <section>
      <div class="container">
        <div class="card" style="padding:20px">
            <h3>TAMBAH PENCEGAHAN</h3>
            <hr/>
            <form action="prosestambahpencegahan.php" method="POST">
                <div class="form-group">
                    <label>Kode Pencegahan</label>
                    <input type="text" name="kd_pencegahan" class="form-control" />
                </div>
                <div class="form-group">
                ...
                <table class="table table-bordered table-hover" id="gejala" class="display" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th width="200"><center>KODE PENCEGAHAN</center></th>
                            <th><center>KODE PENYAKIT</center></th>
                            <th width="350"><center>DESKRIPSI</center></th>
                    ...
                    <?php 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a  href="editpencegahan.php?id=<?php echo $data['kd_pencegahan']; ?>" class="btn btn-sm btn-warning">UBAH</a>
                                </td>
                            </tr>  
                        <?php } ?>
                        </tbody>
